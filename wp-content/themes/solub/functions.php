...
function solub_theme_scripts() {
    ...
    // js files
	wp_enqueue_script( 'bootstrap-bundle', get_template_directory_uri() . '/assets/bootstrap-bundle.js', array( 'jquery' ), '5.1.3', true );
	wp_enqueue_script( 'isotope-pkgd', get_template_directory_uri() . '/assets/isotope-pkgd.js', array( 'imagesloaded' ), '3.0.5', true );
	wp_enqueue_script( 'magnific-popup', get_template_directory_uri() . '/assets/magnific-popup.js', array( 'jquery' ), '1.1.0', true );
	wp_enqueue_script( 'solub-main', get_template_directory_uri() . '/assets/main.js', array( 'jquery' ), '1.0.0', true );
	wp_enqueue_script( 'purecounter', get_template_directory_uri() . '/assets/purecounter.js', array( 'jquery' ), '1.5.0', true );
	wp_enqueue_script( 'slick', get_template_directory_uri() . '/assets/slick.js', array( 'jquery' ), '1.0.0', true );
	wp_enqueue_script( 'swiper-bundle', get_template_directory_uri() . '/assets/swiper-bundle.js', array( 'jquery' ), '8.2.2', true );
	wp_enqueue_script( 'waypoints', get_template_directory_uri() . '/assets/waypoints.js', array( 'jquery' ), '4.0.0', true );
	wp_enqueue_script( 'wow', get_template_directory_uri() . '/assets/wow.js', array( 'jquery' ), '1.1.3', true );
